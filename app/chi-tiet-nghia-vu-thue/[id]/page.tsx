...
export default function ChiTietNghiaVuThuePage() {
  ...
  useEffect(() => {
    ...
    setUserDetails((previous) => ({
      mst: localStorage.getItem("userMST") ?? previous.mst,
      fullName: localStorage.getItem("userName") ?? previous.fullName,
    }))
  }, [])

  // Mock data - will be replaced với nguồn dữ liệu thật sau này
