...
export function Sidebar({ isOpen, onClose, userName = "TỪ XUÂN CHIẾN" }: SidebarProps) {
  const router = useRouter()
  const [mounted, setMounted] = useState(false)
  const [displayName, setDisplayName] = useState(userName)
  const [displayMst, setDisplayMst] = useState("")
  ...
  useEffect(() => {
    ...
    const storedMst = localStorage.getItem("userMST")
  ...
  const handleLogout = () => {
    if (typeof window !== "undefined") {
      ...
      localStorage.removeItem("userMST")
